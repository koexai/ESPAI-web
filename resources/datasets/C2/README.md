# MOS2 Synthetic X-ray Event Distribution (KDE)
...
The synthetic data was created to simulate the statistical distribution of background or source events for the **XMM-Newton MOS2 instrument** (or similar X-ray detectors), trained on observational event lists.
...
```text
MOS2_synthetic_dataset/
├── README.md                           # This file
├── metadata.json                       # Machine-readable metadata
├── mos2_generated_distribution_KDE.csv # Main dataset (CSV format)
└── supplementary/
...
1. **Data Preprocessing** – Cleaning and normalization of real MOS2 observational data.
...
> Luca Naso et al. (2025). *MOS2 Synthetic X-ray Event Distribution (KDE)* (Version 1.0.0).
> Generated using Kernel Density Estimation.

### BibTeX Citation

```bibtex
@dataset{luca2025mos2kde,
  author       = {Luca Naso et al.},
  title        = {MOS2 Synthetic X-ray Event Distribution (KDE)},
  year         = {2025},
  version      = {1.0.0},
