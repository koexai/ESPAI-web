# Provenance and Methods: ESPAI Synthetic EPIC-pn Camera Flare events (Version 1.0)
...
* **Target Data**: Observations from the EPIC-pn detector.
...
* **Data Scope**: The model is currently optimized for the EPIC-pn detector instrumental background.
...
2. **Dataset Expansion**: Applying the optimized framework to other XMM-Newton instruments beyond pn.
