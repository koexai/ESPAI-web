# MOS1 Synthetic X-ray Event Distribution (KDE)
...
1. **Data Preprocessing** – Cleaning and normalization of real MOS1 observational data.
...
> Luca Naso et al. (2025). *MOS1 Synthetic X-ray Event Distribution (KDE)* (Version 1.0.0).
> Generated using Kernel Density Estimation.

### BibTeX Citation

```bibtex
@dataset{luca2025mos1kde,
  author       = {Luca Naso et al.},
  title        = {MOS1 Synthetic X-ray Event Distribution (KDE)},
  year         = {2025},
  version      = {1.0.0},
